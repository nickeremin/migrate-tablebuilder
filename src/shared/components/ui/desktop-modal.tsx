...
const DesktopModal = DialogPrimitive.Root

const DesktopModalTrigger = DialogPrimitive.Trigger
...
DesktopModalContent.displayName = DialogPrimitive.Content.displayName

const DesktopModalTitle = React.forwardRef<
...
DesktopModalTitle.displayName = DialogPrimitive.Title.displayName

const DesktopModalDescription = React.forwardRef<
...
DesktopModalDescription.displayName = DialogPrimitive.Description.displayName
